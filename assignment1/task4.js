...
// ################ Edit your code below
    pose = pose
        .multiply(SimpleMatrix.translate(...this.position))
        .multiply(rotateAroundAxisAtPoint(this.jointAxis, this.jointAngle, this.jointLocation));
    if(this.parent) {
...
// ################ Edit your code below
    pose = pose
        .multiply(this.computePoseMatrix())
        .multiply(SimpleMatrix.scale(...this.scale));
// ################
